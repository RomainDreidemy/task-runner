...
const TodoItem = ({id, title, completed}) => {
    ...
    return (
        <TouchableOpacity style={tailwind(  `h-12 bg-${isCompleted ? 'green' : 'red'}-300 mb-2 flex-1 flex-row justify-between p-2 items-center border rounded-lg border-transparent`)} onPress={() => {
